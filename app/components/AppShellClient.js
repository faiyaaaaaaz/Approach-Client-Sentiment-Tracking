...
/* FINAL CONTRAST: locked permission overlay + shell */
.locked-card {
...
.locked-card::before,.locked-card::after,.locked-orb { display: none !important; }
.locked-card span { color: var(--brand-hover) !important; -webkit-text-fill-color: var(--brand-hover) !important; opacity: 1 !important; }
.locked-card h2 { color: var(--text) !important; -webkit-text-fill-color: var(--text) !important; opacity: 1 !important; }
.locked-card p { color: var(--muted) !important; -webkit-text-fill-color: var(--muted) !important; opacity: 1 !important; }
.locked-link { background: var(--brand) !important; color: #fff !important; -webkit-text-fill-color: #fff !important; border: 1px solid var(--brand) !important; box-shadow: inset 0 1px 0 rgba(255,255,255,.2) !important; }
html[data-theme="light"] .locked-card { background: #FFFFFF !important; color: #181B26 !important; border-color: #CBD5E1 !important; }
html[data-theme="light"] .locked-card h2 { color: #111827 !important; -webkit-text-fill-color: #111827 !important; }
html[data-theme="light"] .locked-card p { color: #334155 !important; -webkit-text-fill-color: #334155 !important; }
html[data-theme="light"] .locked-card span { color: #432AD8 !important; -webkit-text-fill-color: #432AD8 !important; }
.nav-link.locked-nav, .admin-subnav-link.locked-nav { opacity: .8 !important; }
