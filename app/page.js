  ...
  const cards = [
    {
      ...
      description:
        "This dashboard will later organize completed audit runs, key summaries, and performance insights.",
    },
    {
      title: "Run Analysis",
      description:
        "Use the Run Audit section in the left sidebar to start a new audit with date range and limiter controls.",
    },
    {
      title: "Admin Controls",
      description:
        "The Admin section will later manage approved test users, API keys, prompt settings, and system controls.",
    },
  ];
    ...
    >
      <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            Dashboard for audit results, summaries, and system overview.
          </h1>
          ...
          >
            This page is now reserved for dashboard content only. Use the left
            sidebar to open <strong>Run Audit</strong> for the full audit
            workflow.
          </p>
        </section>
