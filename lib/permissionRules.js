export const PLATFORM_OWNER_EMAIL = String(process.env.PLATFORM_OWNER_EMAIL || "").trim().toLowerCase();
...
export function isPlatformOwnerEmail(email) {
  return Boolean(PLATFORM_OWNER_EMAIL && normalizeEmail(email) === PLATFORM_OWNER_EMAIL);
}
